...
public class JsonAdaptedCompanyTest {
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedCompany company = new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_PHONE,
                null, VALID_ROLE, VALID_DEADLINE, VALID_STATUS, VALID_RECRUITER_NAME, VALID_PRIORITY);
    ...
    public void toModelType_nullRole_throwsIllegalValueException() {
        JsonAdaptedCompany company = new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_PHONE,
                VALID_EMAIL, null, VALID_DEADLINE, VALID_STATUS, VALID_RECRUITER_NAME, VALID_PRIORITY);
    ...
    public void toModelType_nullDeadline_throwsIllegalValueException() {
        JsonAdaptedCompany company = new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROLE,
                null, VALID_STATUS, VALID_RECRUITER_NAME, VALID_PRIORITY);
    ...
    public void toModelType_nullStatus_throwsIllegalValueException() {
        JsonAdaptedCompany company = new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROLE,
                VALID_DEADLINE, null, VALID_RECRUITER_NAME, VALID_PRIORITY);
    ...
    public void toModelType_nullRecruiterName_throwsIllegalValueException() {
        JsonAdaptedCompany company = new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROLE,
                VALID_DEADLINE, VALID_STATUS, null, VALID_PRIORITY);
    ...
    public void toModelType_nullPriority_throwsIllegalValueException() {
        JsonAdaptedCompany company = new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_PHONE, VALID_EMAIL, VALID_ROLE,
                VALID_DEADLINE, VALID_STATUS, VALID_RECRUITER_NAME, null);
